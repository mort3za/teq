...
`);
  ...
  function applyProgress(p) {
    ...
    progressText.textContent = isPaused ? t("popup.progress.paused", { done: p.done, total: p.total }) : isWaiting ? t("popup.progress.waiting", { suffix: waitingSuffix(p), done: p.done, total: p.total }) : t("popup.progress.blocking", { done: p.done, total: p.total });
